...
from kalman import kfilter, ksmooth
...
plt.savefig("../figure/locallev1.png")
...
plt.plot(t,ans2['x_s']-2*np.sqrt(ans2['v_s']),'--r');
plt.savefig("../figure/locallev2.png")
```
...
with open('console.txt', 'w') as txt:
    for i, noise in enumerate(nList):
        ...
        if i%2 != 0:
            txt.write('noise={0}  phi1={1:6.3f}, phi2={2:6.3f}, phi3={3:6.3f} \n'.format(noise, *est))
txt.close()
